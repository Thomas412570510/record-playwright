...
def fix_file(filepath):
    # Read using utf-8-sig to correctly handle the BOM if it exists
    with open(filepath, 'r', encoding='utf-8-sig') as f:
        content = f.read()

    # Apply the old strings from commit 8e68261
    old_depth = """def get_depth_info():
    cwd = os.getcwd()
    ...
    # Write back as utf-8-sig to preserve BOM (standard in Windows)
